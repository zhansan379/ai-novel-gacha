...
class LLMGateway:
    ...
    async def complete(self, *, task: str, system: str, user: str, max_tokens: int | None = None) -> str:
        ...
        if not api_key:
            ...
            return await mock.complete(task=task, system=system, user=user, max_tokens=max_tokens or route.max_tokens)
