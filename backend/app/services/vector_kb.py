...
_SEED = [
    {
        ...
        "note": "刘强东是身家极高的电商巨头创办者；其早年是有名的民间掌故——1992年考上中国人民大学，家乡宿迁来龙镇光明村乡亲凑了500块钱和76个鸡蛋送他北上求学。若前提是『我/一位青年帮助(资助)刘强东』这类反事实或温情设定，属合理创作，应保留『帮助→报恩→并肩共事』的逻辑主线，不得反转施助与受助关系、不得把500个鸡蛋替换成别的象征物；与史实相悖处须在叙事中点明是架空/演绎，不得把虚构冒充为已发生的现实事实。",
    },
    {
